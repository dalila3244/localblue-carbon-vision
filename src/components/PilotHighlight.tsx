...
const PilotHighlight = () => {
  ...
  return (
    <section id="pilot" className="bg-coral py-16 sm:py-24 relative">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col lg:flex-row gap-10">
          <div className="lg:w-1/2">
            <h3 className="text-white text-2xl font-bold mb-4 font-poppins">Launching in Guadeloupe</h3>
            <p className="text-white/90 mb-8 text-lg">
              Our 2025 pilot program is rolling out across the protected mangrove forests of Guadeloupe, 
              working with local communities and conservation groups to map, monitor, and monetize 
              this crucial blue carbon ecosystem.
            </p>
            
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 mb-8">
              <h4 className="text-white text-lg font-semibold mb-3">Citizen-Scientist Signups</h4>
              <div className="flex items-center justify-between mb-2">
                <span className="text-white">{signups}/100 participants</span>
                <span className="text-white/70 text-sm">{signups}% complete</span>
              </div>
              <Progress value={signups} className="h-2 bg-white/30" />
            </div>
            
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 mb-8">
              <h4 className="text-white text-lg font-semibold mb-2">Carbon Impact</h4>
              <div className="flex items-baseline">
                <span className="text-4xl font-bold text-white">{carbonCredits.toLocaleString()}</span>
                <span className="text-white ml-2 text-xl">mapped</span>
                <span className="text-white mx-2 text-xl">→</span>
                <span className="text-4xl font-bold text-white">3,750</span>
                <span className="text-white ml-2 text-xl">t CO₂ credits potential</span>
              </div>
            </div>
